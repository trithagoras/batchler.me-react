...
function About() {
  ...
  return (
    <div>
      ...
      <p>
        I originally did four years studying Computer Science at UQ but very
        gradually came to realise that I'm pretty terrible at the
        paper-examination format that UQ liberally uses, and found that QUT
        typically prefers large assignments (which are much more fun and
      ...
      <p>
        ...
        work on my own programming language, dFunc.
      </p>
    </div>
  );
}
